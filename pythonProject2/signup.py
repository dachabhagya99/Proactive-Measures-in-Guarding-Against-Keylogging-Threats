...
def connect_database():
    if emailEntry.get()=='' or U_E.get()=='' or P_E.get()=='' or C_P_E.get()=='':
        ...
        try:
            con=pymysql.connect(host='localhost',user='root',password='pass@123')
            mycursor=con.cursor()
        except:
...
C_PLabel=Label(frame,text='Conformed Password',font=('Microsoft Yauheni UI Light',10,'bold'),bg='white',fg='firebrick1')
...
Allready=Label(frame,text='Do not have account?',font=('open Sans',9,'bold'),fg='firebrick1',bd=0,bg='white')
Allready.grid(row=11,column=0,sticky='w',padx=10,pady=10)

loginButton=Button(frame,text='Login',font=('Open Sans',9,'bold underline'),fg='blue',bg='white',activeforeground='blue',activebackground='white',cursor='hand2',
